...
// Traggo stores tag colours as "#rrggbb" hex strings. Bridge those to SwiftUI's
...
extension Color {
    ...
    /// A legible text colour (black or white) to sit on top of this colour.
    ...
    /// "#rrggbb" in sRGB, or nil if the colour can't be represented there.
